        ...
        <div className="min-h-screen bg-surface-white pt-6 pb-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                    ...
                    <div className="bg-dusty-rose/10 rounded-2xl aspect-square w-full flex items-center justify-center p-8 overflow-hidden relative border border-line">
                        <div className="absolute inset-0 bg-gradient-to-tr from-warm-stone/40 to-transparent"></div>
                        <Heart className="w-24 h-24 text-dusty-rose/40 absolute" />
                        <h2 className="text-4xl font-heading font-bold text-dusty-rose relative z-10 opacity-70">
                            Danis
                        </h2>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-line text-center group hover:border-dusty-rose transition-colors">
                        ...
                        <h3 className="text-xl font-heading font-bold text-dusty-rose mb-3">Produção Artesanal</h3>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-line text-center group hover:border-dusty-rose transition-colors">
                        ...
                        <h3 className="text-xl font-heading font-bold text-dusty-rose mb-3">Fios Premium</h3>
                        <p className="text-slate text-sm">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-line text-center group hover:border-dusty-rose transition-colors">
                        ...
                        <h3 className="text-xl font-heading font-bold text-dusty-rose mb-3">Muito Amor</h3>
                        <p className="text-slate text-sm">
                ...
                <div className="bg-dusty-rose/5 p-8 md:p-12 rounded-2xl text-center border border-dusty-rose/20">
                    ...
                    <Link href="/monte-seu-kit" className="inline-block bg-dusty-rose hover:bg-deep-rose text-white px-8 py-3 rounded-full font-bold transition-all transform active:scale-95 shadow-md">
