 ...
 */
export async function performReprice(customUnitPrices: Record<string, number>, customKitPrices: Record<string, number>) {
...
export async function POST(req: Request) {
    try {
        ...
        const result = await performReprice(customUnitPrices, customKitPrices);
