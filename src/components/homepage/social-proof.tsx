        ...
        <div className="w-full bg-sage-green/10 pt-16 md:pt-24 pb-16 overflow-hidden relative border-t border-black/5">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                    ...
                    {/* Grupo de Identidade Visual (Imagem + Botão) */}
                    <div className="flex flex-col items-center gap-8 shrink-0 w-full md:w-auto relative z-10">
                        ...
                        {/* Botão de Seguir (Centralizado) */}
                        <a 
                            href="https://instagram.com/danisparabebe" 
                            target="_blank" 
                            rel="noreferrer"
                            className="group inline-flex items-center p-2 pr-6 bg-white rounded-full border-2 border-sage-green-dark shadow-[4px_4px_0px_rgba(43,76,63,1)] hover:translate-y-1 hover:shadow-[0px_0px_0px_rgba(43,76,63,1)] transition-all cursor-pointer"
                        >
